...
- Delegation transfers ownership. Once `start_subagent` accepts a task, that subagent owns its entire assigned scope until it settles. Work only on clearly disjoint scope; if none remains, end the turn and let automatic completion resume it.
